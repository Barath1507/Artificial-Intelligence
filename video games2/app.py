...
def predict():
    ...
    input_data = pd.DataFrame([[platform, genre, publisher, na_sales, eu_sales, jp_sales, other_sales]],
    columns=['Platform', 'Genre', 'Publisher', 'NA_Sales', 'EU_Sales', 'JP_Sales', 'Other_Sales'])
    ...
    return render_template("index.html", prediction_text="Predicted information of Global sales: {}%".format(formatted_prediction))
